...
[] spawn {
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBar")displayCtrl 1000)ctrlSetText format["%3 | FPS: %1 || Joueur connecté : %2 | RESTART IN: %7:%8 | TS : 37.59.158.67:8030 ", round diag_fps, count playableUnits, _hours, _minutes, _counter];
	}; 
};
