...
switch (_vehicle) do
{
	case "C_Offroad_01_F" :
	{
		switch (_index) do
		{
			...
			case 7: {_color = "Black"};
			case 8: {_color = "Taxi"};
			case 9: {_color = "Gendarme"};
			case 10: {_color = "Medical2"};
		};
	};
	...
	case "C_Hatchback_01_F":
	{
		switch (_index) do
		{
			...
			case 6: {_color = "Grey"};
			case 7: {_color = "Black"};
			case 8: {_color = "Grise / orange"};
			case 9: {_color = "cox 53"};
			case 10: {_color = "Vert Tribal"};
		};
	};
	...
	case "C_SUV_01_F":
	{
		switch (_index) do
		{
			...
			case 6: {_color = "Medic";};
			case 7: {_color = "Subaru";};
			case 8: {_color = "Simpson"};
			case 9: {_color = "Ferrari"};
			case 10: {_color = "Rebel camo"};
		};
	};
	...
	case "C_Heli_Light_01_civil_F":
	{
		switch (_index) do
		{
			...
			case 2: {_color = "digital"};
			case 3: {_color = "elliptical"};
			case 4: {_color = "furious"};
			case 5: {_color = "graywatcher"};
			case 6: {_color = "jeans"};
			case 7: {_color = "light"};
			case 8: {_color = "shadow"};
			case 9: {_color = "sheriff"};
			case 10: {_color = "speedy"};
