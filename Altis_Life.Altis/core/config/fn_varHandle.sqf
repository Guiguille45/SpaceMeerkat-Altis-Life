...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "bagcorner": {"life_inv_bagcorner"};
			case "coneroutier": {"life_inv_coneroutier"};
			case "Roadfence": {"life_inv_Roadfence"};
			case "kidney": {"life_inv_kidney"};
			case "aluminum": {"life_inv_aluminum"};
			case "sulfur": {"life_inv_sulfur"};
			case "grenadebact": {"life_inv_grenadebact"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_bagcorner": {"bagcorner"};
			case "life_inv_coneroutier": {"coneroutier"};
			case "life_inv_Roadfence": {"Roadfence"};
			case "life_inv_kidney": {"kidney"};
			case "life_inv_aluminum": {"aluminum"};
			case "life_inv_sulfur": {"sulfur"};
			case "life_inv_grenadebact": {"grenadebact"};
