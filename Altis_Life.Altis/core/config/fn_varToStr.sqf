...
switch (_var) do
{
	...
	case "life_inv_bagcorner": {(localize "STR_Item_bagcorner")};
	case "life_inv_coneroutier": {(localize "STR_Item_coneroutier")};
	case "life_inv_Roadfence": {(localize "STR_Item_Roadfence")};
	...
	case "life_inv_aluminum": {(localize "STR_Item_Alu")};
	case "life_inv_sulfur": {(localize "STR_Item_Souffre")};
	case "life_inv_grenadebact": {(localize "STR_Item_GrenadeBact")};
	...
	case "license_cop_gign": {(localize "STR_License_gign")};
	case "license_cop_cg": {(localize "STR_License_CG")};
	case "license_civ_rebel": {(localize "STR_License_Rebel")};
	case "license_civ_mercenaire": {(localize "STR_License_mercenaire")};
	case "license_civ_vip": {(localize "STR_License_vip")};
	...
	case "license_civ_grenade": {(localize "STR_License_Grenade")};
};
