...
switch (life_veh_shop select 0) do
{
	...
	case "cop_air_avion": {_ret = license_cop_air;};
	case "civ_truck":	{_ret = license_civ_truck;};
	case "car_vip":	{_ret = license_civ_vip;};
	case "truck_vip":	{_ret = license_civ_vip;};
	case "air_vip":	{_ret = license_civ_vip;};
	case "ship_vip":	{_ret = license_civ_vip;};
	case "merc":	{_ret = license_civ_mercenaire;};
