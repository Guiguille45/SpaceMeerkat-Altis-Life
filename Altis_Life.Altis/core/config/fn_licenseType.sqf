...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "gign": {_var = "license_cop_gign"}; //Gign License cost
			...
			case "merc": {_var = "license_civ_mercenaire"}; //License armée privée
			case "vip": {_var = "license_civ_vip"}; //License pour vip
			...
			case "grenade": {_var = "license_civ_grenade"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_cop_gign": {_var = "gign"}; //Gign License cost
			...
			case "license_civ_mercenaire": {_var = "merc"}; //License armé privée
			case "license_civ_vip": {_var = "vip"}; //License pour vip
			...
			case "license_civ_grenade": {_var = "grenade"};
			default {_var = ""};
		};
	};
};
