...
switch(true) do
{
	...
	{
		[[0,"News: Interpol à arreté un trafic de drogue international!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Le Pétrole en perte de vitesse!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Altis construit un marché international!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Les investisseurs perdent confiance dans l'or!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: L'Industrie électronique nécessite des métaux précieux!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Les investisseurs perdent confiance dans le dollars!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Nouveaux marché de drogue synthétique découvert!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: La chine achete des tortues concidéré comme des médicaments, les militants se battent !"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
